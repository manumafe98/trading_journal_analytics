import { TradingPlanSection } from '@/components/dashboard/journal/TradingPlanSection';
import { ArrowLeftIcon } from 'lucide-react';
import Link from 'next/link';
import { ThemeSwitch } from '@/components/shared/ThemeSwitch';

export default function ManuelTradingPlanPage() {
    return (
        <div className="min-h-screen w-full bg-gray-50 dark:bg-gray-900">
            <div className="sticky top-0 z-10 flex items-center justify-between border-b border-gray-100 dark:border-gray-800 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md px-6 py-3">
                <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm font-semibold text-violet-500">Manuel Maxera</span>
                    <span className="text-gray-300 dark:text-gray-600">/</span>
                    <span className="text-sm font-semibold text-violet-500">Trading Plan</span>
                </div>
                <ThemeSwitch />
            </div>
            <TradingPlanSection investorName="Manuel Maxera" />
        </div>
    );
}
