...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'neon-glow': '0 0 24px -4px rgba(163, 230, 96, 0.3)',
        'neon-glow-intense': '0 0 16px 0px rgba(163, 230, 96, 0.5)',
        'panel': '0 10px 15px -3px rgba(0, 0, 0, 0.5), 0 4px 6px -2px rgba(0, 0, 0, 0.3)',
        'floating-dock': '0 20px 25px -5px rgba(0, 0, 0, 0.8), 0 10px 10px -5px rgba(0, 0, 0, 0.4)',
      },
      typography: ({ theme }) => ({
        DEFAULT: {
          css: {
